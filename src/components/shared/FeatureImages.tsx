    ...
    <section id="features" className="py-24">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Interactive image grid demo in a premium double-bezel */}
            ...
            <div className="double-bezel-inner p-5 space-y-4">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <button
                  ...
                  className="text-[11px] px-2.5 py-1 rounded-lg bg-white/8 text-white/60 hover:bg-white/12 hover:text-white transition-all duration-200 active:scale-95 border border-white/8 cursor-pointer"
                >
                  {t("featImgSelectAll")}
                </button>
                <button
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={cn(
                    "text-[11px] px-3 py-1.5 rounded-lg font-semibold transition-all duration-200",
                    selected.size > 0 ? "bg-primary text-white hover:bg-primary/80 active:scale-95 cursor-pointer" : "bg-white/5 text-white/30 cursor-not-allowed"
                  )}
                >
                  {t("featImgDownloadSelected")} ({selected.size})
                </button>
                <button
                  className="text-[11px] px-3 py-1.5 rounded-lg font-semibold transition-all duration-200 active:scale-95 bg-white/8 text-white/60 hover:bg-white/12 hover:text-white/90 cursor-pointer border border-white/8"
                >
