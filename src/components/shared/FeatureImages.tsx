...
const MOCK_IMAGES = [
  ...
  {
    id: 2,
    url: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=300&auto=format&fit=crop&q=60",
    size: "400×400",
    name: "avatar.png",
  },
  {
    id: 3,
    url: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=300&auto=format&fit=crop&q=60",
    size: "1200×630",
    name: "og-image.jpg",
  },
  {
    id: 4,
    url: "https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=300&auto=format&fit=crop&q=60",
    size: "320×120",
    name: "logo.svg",
  },
  {
    id: 5,
    url: "https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?w=300&auto=format&fit=crop&q=60",
    size: "800×800",
    name: "product.jpg",
  },
  {
    id: 6,
    url: "https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=300&auto=format&fit=crop&q=60",
    size: "2048×2048",
    name: "texture.png",
  },
  {
    id: 7,
    url: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=300&auto=format&fit=crop&q=60",
    size: "640×480",
    name: "gallery-1.jpg",
  },
  {
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="glass-card rounded-2xl p-4 space-y-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <button
                onClick={() =>
                  setSelected(new Set(MOCK_IMAGES.map((i) => i.id)))
                }
              ...
              >
                <option value="original" className="bg-[#15151a] text-white">
                  {t("featImgOriginal")}
                </option>
                <option value="png" className="bg-[#15151a] text-white">
                  PNG
                </option>
                <option value="jpeg" className="bg-[#15151a] text-white">
                  JPEG
                </option>
                <option value="webp" className="bg-[#15151a] text-white">
                  WebP
                </option>
              </select>
            </div>
            ...
            <div className="flex gap-2">
              ...
              <button className="text-[11px] px-3 py-1.5 rounded-lg font-semibold transition-all bg-primary text-white hover:bg-primary/80 cursor-pointer">
              ...
              {MOCK_IMAGES.map((img) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 inset-x-0 px-1 pb-0.5 bg-black/40">
                    <p className="text-[8px] text-white/75 truncate font-mono">
                      {img.name}
                    </p>
                  </div>
                </button>
